...
namespace PhotoGallery.Controllers
{
    public class ArtistManagementController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ArtistId,ArtistFirstName,ArtistLastName,ArtistBirthday")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ArtistId,ArtistFirstName,ArtistLastName,ArtistBirthday")] Artist artist)
        {
            if (ModelState.IsValid)
            {
